...
def create_movie(title, genre, rating):
    ...
    Returns:
        movie dictionary or None if any parameter is falsy"""
...
def add_to_watched(user_data, movie):
    """Add a movie to watched list in user_data
    Returns:
...
def add_to_watchlist(user_data, movie):
    """Add a movie to watchlist in user_data
    Returns:
        user_data dictionary
    """
...
def watch_movie(user_data, title):
    """Add movie to a watched list, remove from a watchlist.
    If movie isn't in watchlist - do nothing.
    Returns:
        dictionary user_data with lists inside {[], []}
    """
...
def get_watched_avg_rating(user_data):
    """Get user's average rating of all movies watched.
    Returns:
       float
    """
...
def get_most_watched_genre(user_data):
    """Find the most watched genre in user_data.
    Returns:
        str or None if watched list is falsy
    """
    if not user_data["watched"]:
        return None
    genres_count = get_genre_counts(user_data["watched"])
...
def get_genre_counts(watched_list):
    """Helper function. Get all genres with counts.
    Returns:
       dictionary with 'genre' as key, count as value int
    """
    genres_count = {}
...
def get_unique_watched(user_data):
    ...
    friends_watched = get_friends_watched_movies(
        user_data
    )  # all the movies that friends watched
...
def get_friends_unique_watched(user_data):
    ...
    friends_watched = get_friends_watched_movies(
        user_data
    )  # all movies that friends watched
